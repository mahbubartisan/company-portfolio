...
<html lang="en" dir="ltr">
  ...
  <link href="{{ asset('backend/assets/plugins/ladda/ladda.min.css') }}backend/assets/plugins/ladda/ladda.min.css" rel="stylesheet" />
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li>
                        <a href="{{ route('change.password') }}"> <i class="mdi mdi-key"></i> Change Password </a>
                      </li>
                      <li>
...
@if (Session::has('message')) 
  var type = "{{ Session::get('alter-type', 'info') }}"
